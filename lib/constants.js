...
// 🎯 Définitions officielles des priorités (utilisées pour tooltips + carte d'aide)
export const PRIORITY_DEFINITIONS = {
  A: {
    label: 'Priorité A — Haute',
    short: 'Haute',
    color: 'bg-rose-100 text-rose-800 border-rose-300',
    emoji: '🔴',
    description: 'Exposants incontournables — piliers historiques du forum, partenaires clés, gros contributeurs. Traitement prioritaire, mails personnalisés, relances immédiates.',
  },
  B: {
    label: 'Priorité B — Normale',
    short: 'Normale',
    color: 'bg-amber-100 text-amber-800 border-amber-300',
    emoji: '🟡',
    description: 'Exposants confirmés réguliers — inscrits de façon récurrente, dossier habituellement complet. Suivi standard.',
  },
  C: {
    label: 'Priorité C — Faible',
    short: 'Faible',
    color: 'bg-slate-100 text-slate-700 border-slate-300',
    emoji: '⚪',
    description: '1ère participation ou dossier incomplet — à accompagner, expliquer les démarches, suivi renforcé pour éviter désistement.',
  },
  prospect: {
    label: 'Prospect',
    short: 'Prospect',
    ...
    emoji: '🎯',
    description: 'Contact en cours — pas encore officiellement inscrit. Géré dans le module Prospection.',
  },
};

// 🎯 Définitions officielles des statuts prospect (utilisées pour tooltips + carte d'aide)
export const PROSPECT_STATUS_DEFINITIONS = {
  a_contacter: {
    label: 'À contacter',
    color: 'bg-slate-100 text-slate-700 border-slate-300',
    emoji: '⚪',
    description: 'Prospect identifié. Aucun échange encore. Action : initier un 1er contact par email ou téléphone.',
  },
  contacte: {
    label: 'Contacté',
    color: 'bg-blue-100 text-blue-700 border-blue-300',
    emoji: '🔵',
    description: '1er contact effectué. Attente du retour du prospect. Relancer après quelques jours si sans réponse.',
  },
  interesse: {
    label: 'Intéressé',
    color: 'bg-amber-100 text-amber-700 border-amber-300',
    emoji: '🟠',
    description: 'Le prospect a manifesté un intérêt. À relancer pour confirmer l\'inscription ou obtenir un rendez-vous.',
  },
  converti: {
    label: '✓ Converti',
    color: 'bg-emerald-100 text-emerald-700 border-emerald-300',
    emoji: '🟢',
    description: 'Succès ! Le prospect est devenu exposant officiel — une inscription a été créée automatiquement.',
  },
  refuse: {
    label: 'Refusé',
    color: 'bg-rose-100 text-rose-700 border-rose-300',
    emoji: '🔴',
    description: 'Le prospect a refusé de participer au forum. Conserver pour historique, réessayer dans une future édition.',
  },
  abandonne: {
    label: 'Abandonné',
    color: 'bg-slate-100 text-slate-500 border-slate-200',
    emoji: '⚫',
    description: 'Plus de réponse après plusieurs relances. Dossier clos pour cette édition.',
  },
};
...
export const EVENT_DATES = [
  { label: 'vendredi', date: '2026-08-14', display: 'Vendredi 14 août 2026', start: '11:00', end: '17:00' },
  { label: 'samedi', date: '2026-08-15', display: 'Samedi 15 août 2026', start: '09:00', end: '17:00' },
];

// Heures d'ouverture officielles du Forum (figées, non modifiables par les exposants)
// ⚠️ Officiel 2026 : Vendredi 11h-17h | Samedi 9h-17h
export const EVENT_OPENING_TIME = '09:00'; // borne basse globale (utilisée pour les animations le samedi)
export const EVENT_CLOSING_TIME = '17:00';
export const FRIDAY_OPENING_TIME = '11:00';
export const SATURDAY_OPENING_TIME = '09:00';

// Créneaux horaires d'animation PAR JOUR (1h chacun) — Forum 2026
// Vendredi 14 août : 11h → 17h (6 créneaux d'1h)
// Samedi 15 août : 9h → 17h (8 créneaux d'1h)
export const ANIMATION_HOURLY_SLOTS_FRIDAY = [
...
export const ANIMATION_HOURLY_SLOTS_SATURDAY = [
...
// Helper : récupère les créneaux animation selon la date
export const getAnimationSlotsForDate = (dateStr) => {
  if (dateStr === '2026-08-14') return ANIMATION_HOURLY_SLOTS_FRIDAY;
  if (dateStr === '2026-08-15') return ANIMATION_HOURLY_SLOTS_SATURDAY;
  return ANIMATION_HOURLY_SLOTS_SATURDAY; // fallback
};

// Compatibilité retro (ancien code qui utilisait ANIMATION_HOURLY_SLOTS)
// → on garde le set le plus large (samedi) comme défaut
export const ANIMATION_HOURLY_SLOTS = ANIMATION_HOURLY_SLOTS_SATURDAY;
...
// ⚠️ Forum 2026 : 1 animation par jour OBLIGATOIRE (le stand est tenu toute la journée)
export const MAX_ANIMATION_SLOTS_PER_DAY = 1;
...
export const LOGISTIQUE_PROVISIONS = [
  { icon: '🪑', label: '1 table (180×80 cm)', detail: 'Une table standard est fournie pour chaque stand avec nappes (longue côté client + courte côté intervenant)' },
  ...
  { icon: '☂️', label: 'Stand abrité', detail: 'À l\'intérieur des galeries marchandes fixes selon le site' },
  { icon: '🚗', label: 'Parking', detail: 'Places de parking du magasin' },
];
export const LOGISTIQUE_RULES = [
  '🕘 Arrivée 1h avant l\'ouverture publique pour préparer votre stand (8h max).',
  '🎁 Apportez votre matériel personnel (banderole, flyers, démos, etc. hors orifamme, possibilité de mettre un roll-up à la place).',
  '🧹 Vous êtes responsable de la propreté de votre stand.',
