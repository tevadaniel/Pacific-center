...
export function buildAnimationGrid({ window_start, window_end, expected_count }) {
  ...
  const slots_stand = buildSlots(WIZARD_CONFIG.ANIM_DURATION_STAND_MIN);
  const slots_demo = buildSlots(WIZARD_CONFIG.ANIM_DURATION_DEMO_MIN);

  return {
    duration_min: WIZARD_CONFIG.ANIM_DURATION_STAND_MIN, // rétro-compat (anciens écrans)
    duration_stand_min: WIZARD_CONFIG.ANIM_DURATION_STAND_MIN,
    duration_demo_min: WIZARD_CONFIG.ANIM_DURATION_DEMO_MIN,
