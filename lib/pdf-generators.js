...
export function generateConventionPDF({ org, reg, venue }) {
  return new Promise((resolve, reject) => {
    ...
    doc.font('Helvetica').text(
      'Une caution de vingt mille francs Pacifique (20 000 XPF) est exigée de chaque Exposant. Elle est versée exclusivement par chèque à l\'ordre d\'ARACOM CONSEIL au plus tard quinze (15) jours avant l\'ouverture du forum. Elle est restituée intégralement dans les trente (30) jours suivant la fin de l\'événement, sous réserve : (a) du respect intégral des engagements de présence ; (b) de l\'absence de dégradation du stand ou du mobilier mis à disposition ; (c) du démontage propre du stand à l\'heure prévue. À défaut, l\'Organisateur pourra retenir tout ou partie de la caution à titre de réparation forfaitaire.',
      { align: 'justify' }
    ).moveDown(0.6);
